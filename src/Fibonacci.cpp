...
/* *
 * @brief Tính toán giá trị số Fibonacci tại vị trí n để làm hệ số nhân tiền cược.
...
/* *
 * @brief Đặt lại trạng thái của chiến thuật về mặc định (vị trí đầu tiên trong dãy).
 * @param Không có.
 * @return Không có.
 * */
